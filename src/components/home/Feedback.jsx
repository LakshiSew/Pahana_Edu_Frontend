...
const reviews = [
  {
    id: 1,
    quote:
      "Pahana Edu makes book shopping a breeze! The wide selection and fast delivery make it my go-to for all my reading needs.",
    name: "Amara Perera",
    position: "Teacher",
    image:
  ...
  },
  {
    id: 2,
    quote:
      "I love Pahana Edu's user-friendly website and amazing customer support. Finding my favorite novels has never been easier!",
    name: "Nimali Silva",
    position: "Student",
    image:
  ...
  },
  {
    id: 3,
    quote:
      "Pahana Edu's quality books and special offers keep me coming back. Their stationery collection is perfect for my kids!",
    name: "Kamal Fernando",
    position: "Parent",
    image:
          ...
          <div className="max-w-xl">
            <div className="mb-8">
              ...
              <p className="text-gray-600 font-sans text-base -mt-2 w-[600px]">
                We offer a curated selection of quality books and stationery, with exceptional service and fast delivery to enhance your reading experience.
              </p>
            </div>
          ...
          <div className="relative max-w-sm">
            <div className="mb-8">
              ...
              <p className="text-black text-md font-sans w-[400px]">
                We provide a curated selection of books and stationery, with fast delivery and excellent customer support.
              </p>
            </div>
