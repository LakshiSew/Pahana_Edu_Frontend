    ...
    const fetchCategories = async () => {
      try {
        const response = await axios.get(
          `${API_BASE_URL}/auth/getallcategories`
        );
  ...
  const triggerStarAnimation = (productId) => {
    ...
    star.animate(
      [
        ...
        {
          transform: `translate(${deltaX / 2}px, ${deltaY - 100}px) scale(0.7)`,
          opacity: 0.7,
          offset: 0.5,
        },
        {
    ...
    <div className="relative">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg md:text-xl text-gray-600 font-sans max-w-2xl mx-auto">
              Check out the latest additions to our collection of books and
              stationery!
            </p>
          </div>
          ...
          {loading ? (
            ...
            <div className="text-center text-red-600 font-sans text-lg">
              {error}
            </div>
          ) : products.length === 0 ? (
            <div className="text-center text-gray-600 font-sans text-lg">
      ...
      <style jsx>{`
        .star-animation {
          ...
          width: 20px;
          height: 20px;
          background: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="yellow"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg>')
            no-repeat center;
